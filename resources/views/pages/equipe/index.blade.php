        ...
        <div class="flex flex-col block mt-4 p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <a href="/equipes/{{ $equipe->id }}/show">
                ...
                <ul class="text-black">
                    ...
                    <button class="block my-5 m-auto focus:outline-none text-white bg-purple-700 hover:bg-red-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Voir l'équipe</button>
                </ul>
            </a>
        </div>
        @endforeach
